  ...
  function createWhisperwood() {
    ...
    return {
      ...
      spawns: [
        ...
        { type: 'enemy', enemyType: 'spider', x: 25, y: 15, level: 2 },
        { type: 'enemy', enemyType: 'spider', x: 18, y: 32, level: 2 },
        { type: 'enemy', enemyType: 'mushroom', x: 5, y: 20, level: 2 },
        { type: 'enemy', enemyType: 'treant', x: 38, y: 25, level: 3 },
  ...
  function createShadowmere() {
    ...
    return {
      ...
      spawns: [
        ...
        { type: 'enemy', enemyType: 'wraith', x: 10, y: 25, level: 5 },
        { type: 'enemy', enemyType: 'gargoyle', x: 30, y: 18, level: 5 },
        { type: 'enemy', enemyType: 'mimic', x: 20, y: 20, level: 5 },
  ...
  function createSunscorch() {
    ...
    return {
      ...
      spawns: [
        ...
        { type: 'enemy', enemyType: 'sand_wurm', x: 20, y: 15, level: 6 },
        { type: 'enemy', enemyType: 'sand_wurm', x: 30, y: 30, level: 7 },
        { type: 'enemy', enemyType: 'fire_imp', x: 25, y: 10, level: 5 },
        { type: 'enemy', enemyType: 'fire_imp', x: 42, y: 20, level: 6 },
  ...
  function createFrostpeak() {
    ...
    return {
      ...
      spawns: [
        ...
        { type: 'enemy', enemyType: 'frost_wolf', x: 20, y: 20, level: 6 },
        { type: 'enemy', enemyType: 'frost_wolf', x: 40, y: 15, level: 6 },
        { type: 'enemy', enemyType: 'yeti', x: 10, y: 8, level: 8 },
        { type: 'enemy', enemyType: 'yeti', x: 38, y: 32, level: 8 },
  ...
  function createAbyss() {
    ...
    return {
      ...
      spawns: [
        ...
        { type: 'enemy', enemyType: 'demon', x: 30, y: 20, level: 10 },
        { type: 'enemy', enemyType: 'demon', x: 14, y: 28, level: 11 },
        { type: 'enemy', enemyType: 'lava_golem', x: 38, y: 25, level: 11 },
        { type: 'enemy', enemyType: 'lich', x: 10, y: 30, level: 12 },
        { type: 'enemy', enemyType: 'shadow_assassin', x: 20, y: 10, level: 10 },
        { type: 'enemy', enemyType: 'necromancer_enemy', x: 32, y: 30, level: 11 },
        { type: 'enemy', enemyType: 'void_horror', x: 20, y: 20, level: 13 },
  ...
  function createCrystalSanctum() {
    ...
    return {
      ...
      spawns: [
        ...
        { type: 'enemy', enemyType: 'crystal_golem', x: 10, y: 12, level: 16 },
        { type: 'enemy', enemyType: 'crystal_golem', x: 20, y: 22, level: 16 },
        { type: 'enemy', enemyType: 'elemental_lord', x: 8, y: 10, level: 18 },
        { type: 'enemy', enemyType: 'blood_knight', x: 22, y: 16, level: 17 },
        { type: 'enemy', enemyType: 'phoenix_enemy', x: 18, y: 10, level: 18 },
